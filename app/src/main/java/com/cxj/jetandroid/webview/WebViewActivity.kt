package com.cxj.jetandroid.webview

import android.content.Context
import android.content.Intent
import android.net.Uri
import android.os.Bundle
import com.cxj.jetandroid.base.BaseViewBindingActivity
import com.cxj.jetandroid.databinding.ActivityWebViewBinding
...
class WebViewActivity : BaseViewBindingActivity<ActivityWebViewBinding>() {
    ...
    private fun initWebView() {
        ...
        binding.webView.webViewClient = mWebViewClient //如果不设置则跳系统浏览器
    }
    ...
    override fun onBackPressed() {
        if (binding.webView.canGoBack()) {
            binding.webView.goBack() // 返回上一个浏览页
        } else {
            super.onBackPressed()
        }
    }
